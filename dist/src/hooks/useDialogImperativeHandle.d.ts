...
import { type DependencyArray } from "../useDialog";
/**
 ...
 */
export declare const useDialogImperativeHandle: <Handle>(dialogKey: DialogKey, init: () => Handle, deps?: DependencyArray) => void;
